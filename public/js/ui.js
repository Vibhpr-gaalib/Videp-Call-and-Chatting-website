...
export const updateUiAfterHangUp = (callType)=>{
   ...
   if(callType === constants.callType.VIDEO_PERSONAL_CODE || callType === constants.callType.VIDEO_STRANGER){
     ...
     const chatButton =  document.getElementById("finish_chat_button_container")
     hideElement(chatButton);
   }


   const messageIput = document.getElementById("new_message_input");
   hideElement(messageIput)
   clearMessenger();
